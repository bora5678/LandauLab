from sample.AT_Ramsey_1stharm import directory_management
...
if __name__ == '__main__':
    ...
    fsv.bw(bandwidth=100, sweeppoints=2001, sweepvalue=1.0, sweeptime=1)  # Set bandwidth and sweep time
